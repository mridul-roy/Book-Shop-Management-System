# Generated by Django 5.0.7 on 2024-09-27 07:05
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.CharField(choices=[('B', 'B'), ('C', 'C'), ('G', 'G')], default='B', max_length=1)),
            ],
        ),
        migrations.CreateModel(
            name='Cart',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payment_status', models.CharField(choices=[('P', 'Pending'), ('C', 'Complete'), ('F', 'Filed')], default='P', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature_product', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='store.product')),
